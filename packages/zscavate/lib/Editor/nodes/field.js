...
const isEmpty = require("../../node_modules/.pnpm/lodash-es@4.17.21/node_modules/lodash-es/isEmpty.js");
  ...
  return class FieldNodeView {
    constructor(node, view, getPos) {
      ...
      this.createCustomDOM = () => {
        ...
        if (contextRef.value.mode === _interface.EditorModeEnum.TEMPLATE) {
...
exports.getFieldNodeView = getFieldNodeView;
